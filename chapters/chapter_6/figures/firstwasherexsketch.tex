...
\begin{tikzpicture}[
	...
	\begin{axis}[
		...
		\addplot3 [name path = a, black, domain= 0:1,thick,samples y=0, samples = 500] (x,0,{x^2}) node [midway, pin={[pin distance=.5cm, pin edge={<-,black, out=-30, in=235}]right:$y=x^2$}] {};
		\addplot3 [name path = b, black, domain= 0:1,thick,samples y=0, samples = 500] (x,0,{x^(1/2)}) node [midway, pin={[pin distance=.5cm, pin edge={<-,black, out=120, in=245}]above:$y=\sqrt{x}$}] {};
		\addplot[area plot] fill between[of = a and b, soft clip = {domain = 0:1}];
		\addplot3 [name path = a, black, domain= 0:1,dashed,samples y=0,thick, samples = 500] (x,0,{-x^2}) node [midway, pin={[pin distance=.5cm, pin edge={<-,solid,black, out=30, in=120}]right:$y=-x^2$}] {};
		\addplot3 [name path = b, black, domain= 0:1,dashed,samples y=0,thick, samples = 500] (x,0,{-x^(1/2)}) node [midway, pin={[pin distance=.5cm, pin edge={<-,solid,black, out=200, in=120}]below:$y=-\sqrt{x}$}] {};
		\addplot[area plot] fill between[of = a and b, soft clip = {domain = 0:1}];
